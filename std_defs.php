...
class stddefs
{
	...
	{
		($this->rotl($x, 8) & 0x00ff00ff | $this->rotr($x, 8) & 0xff00ff00);
	}
	public function byte(&$x,&$n)
	{
		((($x) >> (8 * $n)));
	}

	public function get_block(&$x)
	{
			/*
	...
	public function put_block($x)
	{
		$out_blk[3] = $this->io_swap(((u4byte)($x))[0]);
		$out_blk[2] = $this->io_swap(((u4byte*)($x))[1]);
		$out_blk[1] = $this->io_swap(((u4byte*)($x))[2]);
		$out_blk[0] = $this->io_swap(((u4byte*)($x))[3]);
	}


	public function get_key(&$x, $len)
	{
			/*
		((u4byte*)($x))[4] = ((u4byte*)($x))[5] = ((u4byte*)($x))[6] = ((u4byte*)($x))[7] = 0;
		switch(((($len) + 63) / 64))
		{
			case 2:
			((u4byte*)($x))[0] = $this->io_swap($in_key[3]);
			((u4byte*)($x))[1] = $this->io_swap($in_key[2]);
			((u4byte*)($x))[2] = $this->io_swap($in_key[1]);
			((u4byte*)($x))[3] = $this->io_swap($in_key[0]);
			break;
			case 3:
			((u4byte*)($x))[0] = $this->io_swap($in_key[5]);
			((u4byte*)($x))[1] = $this->io_swap($in_key[4]);
			((u4byte*)($x))[2] = $this->io_swap($in_key[3]);
			((u4byte*)($x))[3] = $this->io_swap($in_key[2]);
			((u4byte*)($x))[4] = $this->io_swap($in_key[1]);
			((u4byte*)($x))[5] = $this->io_swap($in_key[0]);
			break;
			case 4:
			((u4byte*)($x))[0] = $this->io_swap($in_key[7]);
			((u4byte*)($x))[1] = $this->io_swap($in_key[6]);
			((u4byte*)($x))[2] = $this->io_swap($in_key[5]);
			((u4byte*)($x))[3] = $this->io_swap($in_key[4]);
			((u4byte*)($x))[4] = $this->io_swap($in_key[3]);
			((u4byte*)($x))[5] = $this->io_swap($in_key[2]);
			((u4byte*)($x))[6] = $this->io_swap($in_key[1]);
			((u4byte*)($x))[7] = $this->io_swap($in_key[0]);
		}
			 */
	}
}
